      ...
      >
        {anim => (
          <div className={cx(cls, classes[anim.status])} {...etc}>
            ...
            {!!corners && (
              <div className={cx(classes.corner, classes.cornerLT)} />
            )}
            {!!corners && (
              <div className={cx(classes.corner, classes.cornerLB)} />
            )}
            {!!corners && (
              <div className={cx(classes.corner, classes.cornerRT)} />
            )}
            {!!corners && (
              <div className={cx(classes.corner, classes.cornerRB)} />
            )}
